...
const BookAppointment = () => {
  ...
  const infoItems = [
    {
      ...
      sub: "First visit assessment at no charge",
    },
    {
      ...
      sub: "Available for urgent bookings",
    },
    {
      ...
      sub: "Certified & experienced specialists",
    },
    {
      ...
      light: "#fffbeb",
      title: "24/7 Support",
      sub: "Emergency helpline always open",
    },
  ];
  ...
  return (
    <>
      ...
      <div
        className="appt-page"
        style={{ background: "#f8f7ff", minHeight: "100vh" }}
      >
        <div
          ref={heroRef}
          style={{
            background:
              "linear-gradient(135deg,#4f1d96 0%,#6d28d9 40%,#3b82f6 100%)",
        ...
        >
          ...
          >
            ...
            >
              Fill in your details below and we'll confirm your session within
              the hour.
            </p>
          </div>
          ...
          >
            <path
              d="M0,32 C360,65 1080,0 1440,32 L1440,65 L0,65 Z"
              fill="#f8f7ff"
            />
          </svg>
        </div>
        ...
        >
          ...
          >
            <div
              style={{
                background: "linear-gradient(135deg,#4f1d96,#6d28d9)",
                padding: "28px 36px",
              }}
            >
              <div
                    ...
                    >
                      ...
                      <span
                        style={{
                          fontSize: 11,
                          color:
                            step === s.num ? "#fff" : "rgba(255,255,255,0.5)",
                    ...
                    {i < steps.length - 1 && (
                      <div
                        style={{
                          ...
                          height: 2,
                          background:
                            step > s.num ? "#4ade80" : "rgba(255,255,255,0.2)",
                          margin: "0 10px 20px",
            ...
            <form onSubmit={handleSubmit} style={{ padding: "36px" }}>
              {step === 1 && (
                ...
                >
                  <div>
                    ...
                    >
                      Let us know who we're booking for.
                    </p>
                  </div>
              ...
              {step === 2 && (
                ...
                >
                  <div>
                    ...
                    >
                      Pick your preferred date, time, and service.
                    </p>
                  </div>
                      ...
                      {services.map((s) => (
                        <button
                          ...
                          style={{
                            ...
                            background:
                              formData.service === s ? "#f5f3ff" : "#f9fafb",
                            color:
                              formData.service === s ? "#7c3aed" : "#4b5563",
                            cursor: "pointer",
                            fontWeight: formData.service === s ? 600 : 400,
              ...
              {step === 3 && (
                ...
                >
                    ...
                    {[
                      ...
                      <div
                        ...
                        style={{
                          ...
                          alignItems: "center",
                          padding: "10px 0",
                          borderBottom: i < 6 ? "1px solid #ede9fe" : "none",
                        }}
                      >
                        <span
                          style={{
                  ...
                  >
                    By confirming, you agree to our appointment policy. We'll
                    contact you to confirm your slot within 1 hour.
                  </p>
