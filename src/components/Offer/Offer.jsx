        ...
        >
          <div className="relative">
            ...
            <img
              ...
              className="relative z-10 w-full max-w-sm lg:max-w-md h-80 lg:h-96 object-cover rounded-3xl shadow-2xl shadow-purple-200"
            />

            {/* Floating badge */}
            <div className="absolute z-20 -bottom-5 -right-5 bg-white rounded-2xl shadow-xl px-5 py-3 flex items-center space-x-3 border border-purple-50">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-600 to-blue-500 flex items-center justify-center text-white text-lg font-bold shadow">
                #1
              </div>
              <div>
        ...
        >
          ...
          <ul className="space-y-3 mb-10">
            {services.map((service, index) => (
              <li
                key={index}
                className={`flex items-center gap-3 bg-white rounded-xl px-5 py-3 shadow-sm border border-gray-100 transition-all duration-500 hover:shadow-md hover:border-purple-200 hover:-translate-y-0.5`}
          ...
          {/* CTA */}
          <Link to="/all-offers">
            <button className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-600 to-blue-500 text-white px-8 py-3.5 rounded-full font-semibold text-base shadow-lg hover:shadow-purple-300 hover:scale-105 transition-all duration-200 group">
              View All Services
              <FontAwesomeIcon
                icon={faArrowRight}
